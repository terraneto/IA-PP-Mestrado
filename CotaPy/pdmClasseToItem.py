...
frame = pd.read_sql('SELECT * FROM siasg.itensLicitacao where !(codigo_item_material is null)', dbConnection)
...
frame.to_sql('Bancodetesteitens', dbConnection, if_exists='append', index=False, method=insert_on_duplicate)