...
def mynavbar():
    return Navbar(
        ...
        Subgroup('Baixar Jsons',
                 ...
                 View('Contratos', 'webui.view_baixa_json_contratos_mensal', vmodulo='comprasContratos',
                 ...
                 View('Licitações (Mensal)', 'webui.view_baixa_json_contratos_mensal', vmodulo='licitacoes',
