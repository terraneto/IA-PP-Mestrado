...
def mynavbar():
    return Navbar(
        ...
        Subgroup('Baixar Jsons',
                 ...
                 View('Contratos', 'webui.view_baixa_json_mensal', vmodulo='comprasContratos',
                 ...
                 View('Licitações (Mensal)', 'webui.view_baixa_json_mensal', vmodulo='licitacoes',
                      vtipo='licitacoes', vano=2022),
                 View('Licitações (Uasg)', 'webui.view_baixa_json_uasg_mensal', vmodulo='licitacoes',
                      vtipo='licitacoes', vano=2022),
                 View('Licitações (Uasg-anual)', 'webui.view_baixa_json_uasg_anual', vmodulo='licitacoes',
                      vtipo='licitacoes', vano=2022),
                 View('Itens das licitações', 'webui.view_baixa_json_itenslicitacoes')
                 ),
        Subgroup('Carregar Jsons',
                 ...
                 Separator(),
                 Text('Módulo Fornecedores'),
                 View('Âmbitos de Ocorrência', 'webui.view_carrega_json_ambitos_ocorrencia'),
                 View('CNAEs', 'webui.view_carrega_json_cnaes'),
                 View('Municípios', 'webui.view_carrega_json_municipios'),
                 Separator(),
                 Text('Módulo Materiais'),
                 ...
                 Separator(),
                 Text('Módulo Licitações'),
                 View('Licitações', 'webui.view_carrega_json_licitacoes'),
